<template>
  <div class="max-w-[1500px] h-full mx-auto">
    <!-- music inspired by section -->
    ...
    <!-- music inspired by end -->
    <!-- multi artise section -->
    ...
    <div class="mt-8 min-w-[800px]">
      <div class="text-white text-xl pl-8 font-semibold inline-block">Highlights</div>
      <div class="py-3"></div>
...
<script setup>
import MixesInspiredBy from "../components/MixesInspireBy.vue";
